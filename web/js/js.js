...
window.onload = function arrancarJuego() {
 leerJson();
    ...
    document.getElementById("dificultad").onclick = function () {
        ...
        construirPartida(modeloNave, dificultad, modeloLuna);
    };
...
function leerJson() {
    ...
    $.ajax({
        ...
        success: function (jsn) {
            ...
            construirPartida(parseInt(jsn.nave), parseInt(jsn.dificultad), parseInt(jsn.luna));
            reanudar();
        },
        error: function (e) {
...
function guardarConfi() {
    ...
    $.ajax({
        method: "POST",
        url: url,
        data: {d: dificultad, n: modeloNave, l: modeloLuna},
        success: function (u) {
            alert(u["mess"]);
        },
        error: function (e) {
...
function construirPartida(nave, dificultad, luna) {
    l_nave=parseInt(nave);
    l_dificultad=parseInt(dificultad);
    l_luna=parseInt(luna);
    switch (l_nave) {
        case 1:
            document.getElementById("imgNave").src = "img/nave.png";
